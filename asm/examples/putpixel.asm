...
label putpixel
  ...
  push r6
  push r7
  load r5,[s1:r1-10]           ; comprobamos que x<WIDTH
  cmp r5,WIDTH
  jae putpixel_fin
  load r7,[s1:r1-8]           ; comprobamos que y<HEIGHT
  cmp r7,HEIGHT
  jae putpixel_fin  
  ...
  and r5,r5&0x8000         ; comprobamos si estamos en los primeros
...
label putchar
  ...
  push r6
  push r7
  load r7,[s1:r1-14]          ; leemos la letra
  ...
  label putchar_bchar
    ...
    load r3,[s1:r1-16]        ; leemos y
    add r3,r3+1               ; añadimos 1 a y
    save r3,[s1:r1-16]        ; guardamos y
...
label writeString
  ...
  push r6
  push r7
  load r5,[s1:r1-8]             ; leemos la direccion del string
  label writeString_bu
    load r7,[r5]                ; leemos la letra
    and r7,r7&0xff           ; comprobamos si es cero (borramos lo que sobra)
    jz writeString_fin
      load r6,[s1:r1-12]         ; leemos x
      push r6                   ; lo guardamos
      load r6,[s1:r1-12]         ; leemos y
      push r6                   ; lo guardamos
